...
| 2 | [求职季作战手册](./docs/求职规划/求职季作战手册.md) | 投递、复盘和面试节奏混乱 |
| 3 | [简历证据库](./docs/简历/简历证据库.md) | 简历经历空泛、缺少可信证据 |
| 4 | [项目实战专题](./docs/项目实战/README.md) | 缺少能讲的项目 |
| 5 | [Java 后端校招学习路线](./docs/基础知识/Java后端校招学习路线.md) | 后端复习没有主线 |
| 6 | [RAG 项目从 0 到 1](./docs/项目实战/RAG项目从0到1.md) | 想做 AI 应用项目但不知道如何落地 |
| 7 | [AI 应用研发工程师求职专题](./docs/AI应用研发/README.md) | 想对标 AI 应用研发岗位 |
| 8 | [项目深挖面试准备清单](./docs/面试攻略/项目深挖面试准备清单.md) | 项目一被追问就露怯 |
| 9 | [面试复盘方法论](./docs/面试攻略/面试复盘方法论.md) | 面完就忘，无法把失败变成积累 |
...
<table>
  <tr>
    <td width="33%">
      ...
      <sub><a href="./templates/README.md">模板工具箱</a> · <a href="./templates/投递管理表模板.md">投递管理表</a></sub><br>
      <sub>简历证据库、投递管理、面试复盘、offer 对比和周计划</sub>
    </td>
    <td width="33%">
